...
namespace CFU.UniversityManagement.WebAPI.Migrations
{
    ...
    [Migration("20220315143200_Initial13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CFU.Domain.StructureContext.DepartmentAggregate.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CFU.Domain.StructureContext.DepartmentAggregate.Department", b =>
                {
                    b.HasOne("CFU.Domain.StructureContext.FacultyAggregate.Department", null)
                        .WithOne()
                        .HasForeignKey("CFU.Domain.StructureContext.DepartmentAggregate.Department", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CFU.Domain.StructureContext.InstituteAggregate.Department", null)
                        .WithOne()
                        .HasForeignKey("CFU.Domain.StructureContext.DepartmentAggregate.Department", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CFU.Domain.StructureContext.FacultyAggregate.Department", b =>
                {
                    ...
                    b.HasOne("CFU.Domain.StructureContext.InstituteAggregate.Department", null)
                        .WithOne()
                        .HasForeignKey("CFU.Domain.StructureContext.FacultyAggregate.Department", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
